...
for i=1:NN
    ...
    string5 = strcat('cylinder { z',num2str(i),'+0.25*dip',num2str(i),' ,z',num2str(i),'-0.9*dip',num2str(i),' 0.04 texture { pigment {color rgb<0.2,0.2,0.2>} finish {phong 0.2} } no_shadow }');
