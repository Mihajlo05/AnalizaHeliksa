...
string10 = strcat('camera { orthographic location <',num2str(0),',',num2str(10*R),',',num2str((zz1 + zz2)),'> look_at  <',num2str(x),',',num2str(y),',',num2str(z),'> sky <0,0,1>}');
...
for i=L:D
   ...
   string4 = strcat('cone { z',num2str(i),'+0.15*dip',num2str(i),' .12 z',num2str(i),'+0.5*dip',num2str(i),', .01 texture { pigment {color rgb<0.2,0.2,0.2>} finish {phong 0.2} } no_shadow }');     string5 = strcat('cylinder { z',num2str(i),'+0.25*dip',num2str(i),' ,z',num2str(i),'-0.49*dip',num2str(i),' 0.04 texture { pigment {color rgb<0.2,0.2,0.2>} finish {phong 0.2} } no_shadow }');
